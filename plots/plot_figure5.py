...
# Define error labels
error_labels = [
    '$\delta_{\mathrm{tol}}^{\scriptscriptstyle \mathrm{DL}}=0$',
...
ax.set_ylabel(r'normalized average $\overline{\mathrm{SE}}$ in (33)')
...
plt.savefig('../figs/figure5.pdf', dpi='figure', format='pdf', transparent='True')

tikzplotlib.save("../tikz/figure5.tex")
