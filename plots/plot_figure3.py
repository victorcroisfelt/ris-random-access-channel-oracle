...
for ue in range(2):
    ...
    ax.plot(np.rad2deg(mask), np.abs(true_snr_dl[ue])**2, linestyle=ue_styles[ue], linewidth=1.5, color='black', label=ue_labels[ue])
    ...
    markerline.set_markeredgecolor('#d95f02')
    ...
    markerline.set_markeredgecolor('#7570b3')
    markerline.set_markerfacecolor('none')
    markerline.set_markersize(7)

ax.set_xlabel(r'reflecting angle, $\theta_r$')
